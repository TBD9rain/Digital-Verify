...
class Scoreboard #(
    ...
    virtual interface preadd_multi_if.env vif;
    ...
    function bit output_check(
        ...
        output_check = (txn_out.data_out === txn_ref.data_out);
    endfunction
    ...
    function bit timing_check(
        ...
        timing_check = (txn_out.timestamp - txn_in.timestamp) == 2;
    endfunction
